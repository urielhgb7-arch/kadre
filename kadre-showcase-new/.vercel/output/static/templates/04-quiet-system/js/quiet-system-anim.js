...
function initQuietAnimations() {
    ...
    const images = document.querySelectorAll('.project-card img, .about-photo');
    images.forEach(img => {
        // Ensure image container has overflow hidden
        const parent = img.parentElement;
        if (parent) {
            parent.style.overflow = 'hidden';
            img.style.height = '120%'; // Make image taller for parallax
